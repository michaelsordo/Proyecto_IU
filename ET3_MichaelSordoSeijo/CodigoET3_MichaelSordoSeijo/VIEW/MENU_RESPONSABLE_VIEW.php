					...
					<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
						<div class="sb-sidenav-menu">
							<div class="nav">
								...
								<br>
								<div class="sb-sidenav-menu-heading">Gestion de reservas</div>
								<br>
								<li class="reservas_usuarios" style="cursor:pointer" onclick="crearform('formenviar','post'); insertacampo(document.formenviar,'action','buscar_reservas_soy_responsable'); insertacampo(document.formenviar,'controlador','HORARIO');enviaform(document.formenviar);"></li>
								<br>
				...
				<div id="layoutSidenav_content">
					<main>
						<div class="container-fluid">
							<h1 class="mt-4 menu_aplicacion_responsable"></h1>
							<ol class="breadcrumb mb-4">
								<li class="breadcrumb-item"><a>Calendario</a></li>
								<li class="breadcrumb-item active menu_aplicacion_responsable"></li>
