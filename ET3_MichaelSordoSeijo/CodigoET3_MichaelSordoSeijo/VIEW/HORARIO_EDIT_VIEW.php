...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="id_calendario" id="id_calendario" class="form-control" value="<?php echo $this->fila['ID_CALENDARIO']; ?>" onblur="if (esNoVacio('id_calendario')) comprobarSoloNumeros('id_calendario',2)">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2 id_recurso" for="id_recurso">ID recurso:</label>
    <div class="col-sm-10">
      <input type="text" name="id_recurso" id="id_recurso" class="form-control" value="<?php echo $this->fila['ID_RECURSO']; ?>" onblur="if (esNoVacio('id_recurso')) comprobarSoloNumeros('id_recurso',3)">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2 fecha_horario" for="fecha_horario">Fecha horario:</label>
    <div class="col-sm-10">
      <input type="date" name="fecha_horario" id="fecha_horario" class="form-control" value="<?php echo $this->fila['FECHA_HORARIO']; ?>" onblur="if (esNoVacio('fecha_horario'))">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="time" name="hora_inicio_horario"  id="hora_inicio_horario" class="form-control" value="<?php echo $this->fila['HORA_INICIO_HORARIO']; ?>" onblur="if (esNoVacio('hora_inicio_horario'))" >
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2 hora_fin_horario" for="hora_fin_horario">Hora fin horario:</label>
    <div class="col-sm-10">
      <input type="time" name="hora_fin_horario" id="hora_fin_horario" class="form-control" value="<?php echo $this->fila['HORA_FIN_HORARIO']; ?>" onblur="if (esNoVacio('hora_fin_horario'))">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2 motivo_horario" for="motivo_horario">Motivo horario:</label>
    <div class="col-sm-10">
      <input type="text" name="motivo_horario" id="motivo_horario" class="form-control" value="<?php echo $this->fila['MOTIVO_HORARIO']; ?>" onblur="if (esNoVacio('motivo_horario')) comprobarLetrasNumeros('motivo_horario',100)">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2 fecha_solicitud_recurso" for="fecha_solicitud_recurso">Fecha solicitud recurso:</label>
    <div class="col-sm-10">
      <input type="date" name="fecha_solicitud_recurso" id="fecha_solicitud_recurso" class="form-control" value="<?php echo $this->fila['FECHA_SOLICITUD_RECURSO']; ?>" onblur="if (esNoVacio('fecha_solicitud_recurso'))">
    </div>
  </div>
    <div class="form-group">
    <label class="control-label col-sm-2 login_usuario" for="login_usuario">Login usuario:</label>
    <div class="col-sm-10">
      <input type="text" name="login_usuario" id="login_usuario" class="form-control" value="<?php echo $this->fila['LOGIN_USUARIO']; ?>" onblur="if (esNoVacio('login_usuario')) comprobarLetrasNumeros('login_usuario',15)">
    </div>
  </div>
     <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="motivo_rechazo_solicitud" id="motivo_rechazo_solicitud" class="form-control" value="<?php echo $this->fila['MOTIVO_RECHAZO_SOLICITUD']; ?>" onblur="if (esNoVacio('motivo_rechazo_solicitud')) comprobarLetrasNumeros('motivo_rechazo_solicitud',100)">
    </div>
  </div>
         <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="coste_solicitud" id="coste_solicitud" class="form-control" value="<?php echo $this->fila['COSTE_SOLICITUD']; ?>" onblur="if (esNoVacio('coste_solicitud')) comprobarSoloNumeros('coste_solicitud',6)">
    </div>
  </div>
